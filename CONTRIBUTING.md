...
- [Contributing to Tech Cheat Sheets](#contributing-to-tech-cheat-sheets)
  ...
  - [11. Source metadata for volatile cloud facts](#11-source-metadata-for-volatile-cloud-facts)
  - [12. Documentation dependency management](#12-documentation-dependency-management)
  - [13. Dependabot update strategy](#13-dependabot-update-strategy)
...
4. In the PR body:
   ...
   - Include screenshots for diagram or layout changes (where applicable).
...
```bash
python3 scripts/validate_mermaid.py docs/azure/files/networking/networking.md
```
...
is generated from it via `uv export`.
